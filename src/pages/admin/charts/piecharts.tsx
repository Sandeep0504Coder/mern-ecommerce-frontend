          ...
          <section>
            <div>
              <PieChart
                ...
                data={ [charts.orderFulfillment[ "processing" ],charts.orderFulfillment[ "shipped" ],charts.orderFulfillment[ "delivered" ] ] }
                backgroundColor={[
                  `hsl(110,80%, 80%)`,
                  `hsl(110,80%, 50%)`,
                  `hsl(110,40%, 50%)`,
          ...
          <section>
            <div>
              <PieChart
                ...
                data={[charts.userAgeGroup.teen, charts.userAgeGroup.adult, charts.userAgeGroup.old]}
                backgroundColor={[
                  `hsl(10, ${80}%, 80%)`,
                  `hsl(10, ${80}%, 50%)`,
                  `hsl(10, ${40}%, 50%)`,
